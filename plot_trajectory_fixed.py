    ...
    <script>
        ...
        legend.onAdd = function(map) {{
            ...
            div.innerHTML = '<h4 style="margin: 0 0 10px 0;">Trajectory Info</h4>' +
                           '<p style="margin: 5px 0;">* Green points: less than 1.0 m error</p>' +
                           '<p style="margin: 5px 0;">* Orange points: 1.0 m or greater error</p>' +
                           '<p style="margin: 5px 0;">Green marker = Start (05:40:23)</p>' +
                           '<p style="margin: 5px 0;">Red marker = End (05:46:55)</p>' +
...
with open('trajectory_map.html', 'w', encoding='utf-8') as f:
    f.write(html)
